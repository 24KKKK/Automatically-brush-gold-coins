var douyinAppName = "抖音极速版";
var douyinVideoNum = 100 // 抖音极速版短视频个数
douyinVideoNum = Math.floor(Math.random() * 10) + douyinVideoNum
...
function slideScreen(movieNum, ranNum) {
    for (var i = 1; i <= movieNum; i++) {
        ...
        var randomNum = Math.floor(Math.random() * 5) + ranNum;
        ...
        tLog("刷了：" + i + " 个视频，共：" + douyinVideoNum + "个视频");
        sleep(1000);
    }
}
